...
public class AppKiller {
    ...
    public static void main(String[] args) {
        ...
        String[] bannedArray = args[0].split(" ");
        bannedProcesses = Arrays.asList(bannedArray);
        for (String string : bannedProcesses) {
        ...
        */
        ...
        System.out.println("Started app killer");
    ...
    private void FillBannedList(List<String> applicationsToBan){
        System.out.println("Entered Fill Ban List");
    }
